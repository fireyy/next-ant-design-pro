...
import lang_enUS0 from "@/locales/en-US.ts";
import faIR0 from "antd/es/locale/fa_IR";
import lang_faIR0 from "@/locales/fa-IR.ts";
import idID0 from "antd/es/locale/id_ID";
import lang_idID0 from "@/locales/id-ID.ts";
import jaJP0 from "antd/es/locale/ja_JP";
import lang_jaJP0 from "@/locales/ja-JP.ts";
import ptBR0 from "antd/es/locale/pt_BR";
import lang_ptBR0 from "@/locales/pt-BR.ts";
