...
import { DEFAULT_METHOD, VALID_METHODS } from "./constants";
...
function parseKey(key: string) {
  ...
  if (len === 1) {
    ...
    const upperCaseMethod = method?.toUpperCase() || DEFAULT_METHOD;
    assert(
